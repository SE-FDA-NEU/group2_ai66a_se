...
- Given the product is already in the database, when I paste its link, then the system returns the data from the database without calling the API and /detail shows it within 2 seconds (BR3).
